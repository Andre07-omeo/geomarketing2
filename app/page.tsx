...
import { MinusCircle, Calendar, Activity,   } from 'lucide-react';
          ...
          <div className="flex-1 flex flex-col min-h-0 bg-slate-900/50 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8 bg-gradient-to-t from-slate-950 via-slate-950 to-transparent flex gap-3">
              ...
              <button
                ...
                className={`flex-1 h-14 rounded-2xl font-black text-[11px] uppercase tracking-[0.1em] flex items-center justify-center gap-2 transition-all ${
                    isSelected ? 'bg-rose-600 text-white' : isLibre ? 'bg-[#d4af37] text-black' : 'bg-slate-800 text-slate-500'
                }`}
              >
